...
macro_rules! impl_consensus_encoding {
    ($thing:ident, $($field:ident),+) => (
        impl bitcoin::consensus::Encodable for $thing {
            #[inline]
            fn consensus_encode<R: bitcoin_io::Write + ?Sized>(
                &self,
                r: &mut R,
        ...
        impl bitcoin::consensus::Decodable for $thing {
            ...
            #[inline]
            fn consensus_decode_from_finite_reader<R: bitcoin_io::Read + ?Sized>(
                r: &mut R,
            ...
            #[inline]
            fn consensus_decode<R: bitcoin_io::Read + ?Sized>(
                r: &mut R,
            ) -> core::result::Result<$thing, bitcoin::consensus::encode::Error> {
...
macro_rules! impl_hashencode {
    ($hashtype:ident) => {
        impl bitcoin::consensus::Encodable for $hashtype {
            fn consensus_encode<W: bitcoin_io::Write + ?Sized>(&self, w: &mut W) -> core::result::Result<usize, bitcoin_io::Error> {
                self.0.consensus_encode(w)
            }
        }

        impl bitcoin::consensus::Decodable for $hashtype {
            fn consensus_decode<R: bitcoin_io::Read + ?Sized>(r: &mut R) -> core::result::Result<Self, bitcoin::consensus::encode::Error> {
